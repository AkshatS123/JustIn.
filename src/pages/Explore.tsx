...
import { Search, Home, Hash, MessageCircle, User } from 'lucide-react';
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-200 px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <h2 className="text-lg font-medium text-gray-700">Explore</h2>
        </div>
      </header>
      ...
      <div className="flex-1 px-4 py-6 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">The Explore page is under development</p>
        </div>
      </div>
